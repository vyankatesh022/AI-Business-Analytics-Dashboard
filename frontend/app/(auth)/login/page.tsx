      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-zinc-900/60 border border-zinc-800/80 p-8 rounded-2xl shadow-2xl backdrop-blur-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-cyan-500 hover:text-cyan-400">Forgot?</Link>
              </div>
              <div className="relative">
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            Don&apos;t have an account? <Link href="/signup" className="text-cyan-500 hover:text-cyan-400 font-medium">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
